...
const String kPrefOsNotifications = 'pref_os_notifications'; // bool, default false (opt-in)
const String kPrefLocale = 'pref_locale'; // the app's locale code (settings_controller)
const String kBgSeenIds = 'bg_seen_ids'; // JSON list<String> of already-notified ids
const String kBgBaselineMs = 'bg_baseline_ms'; // epoch ms; only newer notifications count
const String kBgLastRev = 'bg_last_notif_rev'; // last notifications revision we acted on
const String kBgHeartbeatMs = 'bg_heartbeat_ms'; // last foreground live-refresh tick (epoch ms)
const String kBgRotated = 'bg_rotated'; // bool: the isolate rotated the tokens; adopt on resume
const String kBgRefreshStartedMs = 'bg_refresh_started_ms'; // epoch ms a bg refresh began
