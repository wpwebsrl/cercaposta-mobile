...
String notifTitle(
  ...
  'sales.plan_change_payment_failed' => l.notifPlanChangePaymentFailedTitle,
  'sales.plan_change_retry_started' => l.notifPlanChangeRetryTitle,
  'sales.plan_change_grace_expiring' => l.notifPlanChangeGraceExpiringTitle,
  'sales.plan_change_grace_expired' => l.notifPlanChangeGraceExpiredTitle,
  'sales.plan_change_action_required' => l.notifPlanChangeActionRequiredTitle,
...
String notifBody(
  ...
  'sales.plan_change_payment_failed' => l.notifPlanChangePaymentFailedBody(
    _pDate(n, 'grace_until', locale),
  ),
  'sales.plan_change_retry_started' => l.notifPlanChangeRetryBody,
  'sales.plan_change_grace_expiring' => l.notifPlanChangeGraceExpiringBody(
    _pDate(n, 'grace_until', locale),
  ),
  'sales.plan_change_grace_expired' => l.notifPlanChangeGraceExpiredBody,
  'sales.plan_change_action_required' => l.notifPlanChangeActionRequiredBody,
  _ => '',
};
